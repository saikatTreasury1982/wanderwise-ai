          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="min-w-0">
              ...
              <input
                ...
                className="w-full px-2 py-2.5 sm:px-3 sm:py-3 bg-white/10 border border-white/20 rounded-lg text-white text-sm sm:text-base focus:outline-none focus:border-purple-400"
                required
              />
            </div>
            <div className="min-w-0">
